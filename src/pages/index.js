...
const IndexPage = () => (
  <div>
    ...
    >
      <li className="list">
        <iframe
          src="https://open.spotify.com/embed/user/1226498659/playlist/1fVIzOIeDJfo6R4duhdv6O"
          width="300"
          height="380"
          frameborder="0"
      ...
      <li className="list">
        <iframe
          src="https://open.spotify.com/embed/user/1260969225/playlist/2kkNUsGbsy3HUvIKth86gO"
          width="300"
          height="380"
          frameborder="0"
          allowtransparency="true"
